...
export default class HugCommand extends BaseCommand {
    constructor(client: FuzzyClient) {
        super(client, {
            ...
            args: [
                {
                    name: "target",
                    description: "Member you want to hug",
                    type: "USER",
                    required: true,
                },
            ],
    ...
    async run(interaction: CommandInteraction) {
        ...
        this.client.furryAPI.furry.hug("json", 1).then((img) => {
            ...
            interaction.reply({ embeds: [embed], content: `${interaction.user} Hugged ${target} tightly! ^w^` });
        });
    }
}
