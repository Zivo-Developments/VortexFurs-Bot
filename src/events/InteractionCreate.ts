import { Interaction, MessageActionRow, MessageButton, MessageComponentInteraction, MessageEmbed, MessageSelectMenu, TextChannel } from "discord.js";
    ...
    async run(client: FuzzyClient, interaction: Interaction) {
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId === "start-verification") {
                ...
                const buttonPush = await m!.awaitMessageComponent({
                    filter,
                    time: 60000 * 10,
                ...
                if (verify) {
                    ...
                    switch (interaction.customId.split("-")[0]) {
                        ...
                        case `ACCEPT`:
                            ...
                            if (guild!.roles.cache.get("783684009871802368")) {
                                verifyingMember.roles.remove("783684009871802368").catch((e) => {
