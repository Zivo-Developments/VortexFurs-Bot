        ...
        if (message.author.id === "302050872383242240") {
            ...
            if (message.channel.type == "DM") {
                ...
                if (verify) {
                    ...
                    const questioningChannel = verifyingGuild!.channels.cache.get(
                        ...
                        if (message.content.startsWith("!!")) {
                            ...
                            switch (message.content.slice(2).trim().split(/ +/g)[0]) {
                                case "ban":
                                    ...
                                    if (banReason) {
                                        verifyingMember.send(
                                            `You're banned from ${message.guild!.name} for ${banReason}`,
                                        );
                                        verifyingMember.ban({
                                        ...
                                        message.channel
                                            .send("Make sure you provide a reason for your bans")
                                            .then((m) => {
                                ...
                                case "kick":
                                    ...
                                    if (kickReason) {
                                        verifyingMember.send(
                                            `You're kicked from ${message.guild!.name} for ${kickReason}`,
                                        );
                                        ...
                                        message.channel
                                            .send("Make sure you provide a reason for your kick")
                                            .then((m) => {
                                                setTimeout(() => m.delete(), 1000 * 60 * 1);
                                            });
                                    }
                                ...
                                case "deny":
                                    ...
                                    if (denyReason) {
                                        ...
                                        const embed = new MessageEmbed()
                                            ...
                                            .setAuthor(
                                                verifyingUser.tag,
                                                verifyingUser.displayAvatarURL({ dynamic: true }),
                                            )
                                            .setColor("#ff1493")
                                        ...
                                        message.channel
                                            .send("Make sure you provide a reason for your deny")
                                            .then((m) => {
                                                setTimeout(() => m.delete(), 1000 * 60 * 1);
                                            });
                                    }
                            ...
                            if (message.attachments) {
                                ...
                                return verifyingUser
                                    .send({ content: `**Staff Member**: ${message.content}` })
                                    .then(() => {
                                        message.react("✅");
                                    });
                            }
